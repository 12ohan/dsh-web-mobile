...
@media (max-width: 1023px) and (pointer: coarse) {
  ...
  [data-mobile-nav="frame"] [data-composer-card] select {
    font-size: 16px !important;
  }

  /* Safe area padding for drawer settings & actions so curved corners never clip controls */
  [data-mobile-nav="frame"] [data-mobile-nav="drawer-actions"],
  [data-mobile-nav="frame"] [class*="_settingsArea"],
  [data-mobile-nav="frame"] [data-pane="sidebar"] > :last-child {
