...
exports.isNativeDrawerGeneration = isNativeDrawerGeneration;
exports.ensureDismissShadow = ensureDismissShadow;
exports.updateNativeDrawerGen = updateNativeDrawerGen;
 ...
 */
function isNativeDrawerGeneration(frame) {
    if (frame === null)
        return false;
...
function updateNativeDrawerGen() {
    if (typeof document === 'undefined')
        return;
    const frame = findFrame();
    const root = document.documentElement;
    if (isNativeDrawerGeneration(frame))
        root.setAttribute('data-mobile-nav-gen', 'native-drawer');
    else
        root.removeAttribute('data-mobile-nav-gen');
}
