...
| 关闭抽屉 | 抽屉本体/左区**左滑**；抽屉右缘之外**右滑**；点 backdrop；Escape；导航项 click（顶栏抽屉按钮**只作开启用**——抽屉开着时它被抽屉盖住，点击又被 shim 吞掉，不构成关闭入口，§2） |
...
2. 抽屉开着时 frame 内、抽屉外的点击会被第三方 shim 吞掉并顺手收抽屉——那是该 shim 的设计目的，不是缺陷；顶栏抽屉按钮同理既被抽屉盖住、点击也被吞掉，只作开启用（§3.1）。
